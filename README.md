...
`#statistics`에는 1995년과 2023년을 각각 M+0으로 맞춘 19개 비교 그래프가 있습니다. 미국 기술 IPO 수, 인터넷 IPO와 광의 AI 연관 IPO, 엄격한 AI 핵심기업 최소치, 첫날 수익률, 공모가 기준 P/S, 흑자·적자 비중을 함께 보여 상장 공급·가격·이익의 과열을 따로 볼 수 있습니다. 데스크톱에서는 두 그래프씩 나란히 보이며, 각 그래프 아래에 현재와 닷컴 시기의 차이를 1~2줄로 설명합니다.
