...
> `python -m ai_fc market` — Kalshi·Polymarket·CBOE 옵션(무료·무인증). 생성: 2026-09-26
> **기록·표시 전용** — edge 시그널 발행은 P3 게이트(해소 50+, Brier<0.18) 통과 후.

| 질문 | 시장내재확률 | 소스 | 구성 정의 |
|---|---|---|---|
| fomc-2026-07-29-hike | **0%** | polymarket | P(해당 회의에서 ≥25bp 인상) |
| fomc-2026-10-28-hike | **65%** | polymarket | P(해당 회의에서 ≥25bp 인상) |
| nasdaq-eoy-above-jul9-2026 | **64%** | options_bl | P(만기 종가 임계 상회/하회) — risk-neutral |
| nasdaq-ath-eoy-2026 | **51%** | options_bl (경로 질문의 종점 하한) | P(만기 종가 임계 상회/하회) — risk-neutral |
