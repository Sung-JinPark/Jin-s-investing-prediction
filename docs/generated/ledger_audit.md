...
- Generated: `2026-08-08T03:06:36+00:00`
- Latest completed NYSE day: `2026-08-07`
- Result: accumulating 23 · frozen 1 · stalled 4 · inactive 1 · violation 0 · planned 3
...
| `scenario_archive` | trading_daily | 12 | 2026-08-07 | **stalled** | missing trading days: 2026-08-04, 2026-08-05 |
| `scenario_latest` | trading_daily | 1 | 2026-08-07 | **accumulating** | — |
| `cross_asset_archive` | trading_daily | 10 | 2026-08-06 | **stalled** | missing trading days: 2026-08-04 |
| `cross_asset_latest` | trading_daily | 1 | 2026-08-06 | **stalled** | — |
| `cross_asset_path_tracking` | trading_daily | 1 / 3 | — | **frozen** | — |
| `cross_asset_path_tracking_v2` | trading_daily | 1 / 9 | 2026-08-06 | **stalled** | — |
| `scenario_band_calibration` | trading_daily | 1 / 3 | 2026-08-07 | **accumulating** | — |
...
| `rate_event_archive` | monthly | 5 | 2026-08-06 | **accumulating** | — |
| `realty_rate_sensitivity_archive` | monthly | 5 | 2026-08-06 | **accumulating** | — |
...
| `source_monitoring` | trading_daily | 5 | 2026-08-07 | **accumulating** | — |
| `source_monitoring_status` | trading_daily | 1 | 2026-08-07 | **accumulating** | — |
| `raw_receipts` | event | 0 | — | **planned** | — |
| `quarantine` | event | 0 | — | **planned** | — |
| `bitemporal_facts` | event | 0 | — | **planned** | — |
| `forecast_timestamp_proof` | weekly | 1 | 2026-08-08 | **accumulating** | — |
