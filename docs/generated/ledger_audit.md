...
- Generated: `2026-08-15T02:33:56+00:00`
- Latest completed NYSE day: `2026-08-14`
...
| `ml_market_history` | weekly | 1 | 2026-08-08 | **accumulating** | — |
...
| `scenario_archive` | trading_daily | 17 | 2026-08-14 | **stalled** | missing trading days: 2026-08-04, 2026-08-05 |
| `scenario_latest` | trading_daily | 1 | 2026-08-14 | **accumulating** | — |
| `cross_asset_archive` | trading_daily | 15 | 2026-08-13 | **stalled** | missing trading days: 2026-08-04 |
| `cross_asset_latest` | trading_daily | 1 | 2026-08-13 | **stalled** | — |
| `cross_asset_path_tracking` | trading_daily | 1 / 3 | — | **frozen** | — |
| `cross_asset_path_tracking_v2` | trading_daily | 1 / 24 | 2026-08-13 | **stalled** | — |
| `scenario_band_calibration` | trading_daily | 1 / 28 | 2026-08-14 | **accumulating** | — |
...
| `rate_event_archive` | monthly | 10 | 2026-08-13 | **accumulating** | — |
| `realty_rate_sensitivity_archive` | monthly | 10 | 2026-08-13 | **accumulating** | — |
...
| `source_monitoring` | trading_daily | 12 | 2026-08-14 | **accumulating** | — |
| `source_monitoring_status` | trading_daily | 1 | 2026-08-14 | **accumulating** | — |
| `raw_receipts` | event | 0 | — | **planned** | — |
| `quarantine` | event | 0 | — | **planned** | — |
| `bitemporal_facts` | event | 0 | — | **planned** | — |
| `forecast_timestamp_proof` | weekly | 1 | 2026-08-15 | **accumulating** | — |
