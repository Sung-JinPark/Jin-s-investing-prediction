...
- Latest completed NYSE day: `2026-08-06`
...
| `scenario_archive` | trading_daily | 11 | 2026-08-06 | **stalled** | missing trading days: 2026-08-04, 2026-08-05 |
| `scenario_latest` | trading_daily | 1 | 2026-08-06 | **accumulating** | — |
| `cross_asset_archive` | trading_daily | 9 | 2026-08-05 | **stalled** | missing trading days: 2026-08-04 |
| `cross_asset_latest` | trading_daily | 1 | 2026-08-05 | **stalled** | — |
| `cross_asset_path_tracking` | trading_daily | 1 / 3 | — | **frozen** | — |
| `cross_asset_path_tracking_v2` | trading_daily | 1 / 6 | 2026-08-05 | **stalled** | — |
| `scenario_band_calibration` | trading_daily | 1 / 1 | 2026-08-06 | **accumulating** | — |
...
| `rate_event_archive` | monthly | 4 | 2026-08-05 | **accumulating** | — |
| `realty_rate_sensitivity_archive` | monthly | 4 | 2026-08-05 | **accumulating** | — |
...
| `source_monitoring` | trading_daily | 4 | 2026-08-06 | **accumulating** | — |
| `source_monitoring_status` | trading_daily | 1 | 2026-08-06 | **accumulating** | — |
| `raw_receipts` | event | 0 | — | **planned** | — |
| `quarantine` | event | 0 | — | **planned** | — |
| `bitemporal_facts` | event | 0 | — | **planned** | — |
| `forecast_timestamp_proof` | weekly | 1 | 2026-08-07 | **accumulating** | — |
