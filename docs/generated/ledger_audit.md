...
- Generated: `2026-09-10T06:10:46+00:00`
- Latest completed NYSE day: `2026-09-09`
- Result: accumulating 43 · frozen 2 · stalled 5 · inactive 5 · violation 0 · planned 4

| Ledger | Cadence | Files / rows | Latest | Status | Finding |
|---|---:|---:|---:|---:|---|
| `forecast_records` | event | 56 | 2026-09-09 | **accumulating** | — |
...
| `scenario_archive` | trading_daily | 33 | 2026-09-09 | **stalled** | missing trading days: 2026-08-04, 2026-08-05, 2026-09-03 |
| `scenario_latest` | trading_daily | 1 | 2026-09-09 | **accumulating** | — |
| `cross_asset_archive` | trading_daily | 31 | 2026-09-09 | **stalled** | missing trading days: 2026-08-04, 2026-08-25, 2026-09-03 |
| `cross_asset_latest` | trading_daily | 1 | 2026-09-09 | **accumulating** | — |
| `cross_asset_path_tracking` | trading_daily | 1 / 3 | — | **frozen** | — |
| `cross_asset_path_tracking_v2` | trading_daily | 1 / 72 | 2026-09-09 | **accumulating** | — |
| `scenario_band_calibration` | trading_daily | 1 / 276 | 2026-09-09 | **accumulating** | — |
| `market_event_calendar` | event | 1 / 53 | 2026-08-04 | **accumulating** | — |
| `signal_archive` | weekly | 8 | 2026-09-04 | **accumulating** | — |
| `liquidity_archive` | weekly | 6 | 2026-09-04 | **accumulating** | — |
| `rate_event_archive` | monthly | 26 | 2026-09-09 | **accumulating** | — |
| `realty_rate_sensitivity_archive` | monthly | 26 | 2026-09-09 | **accumulating** | — |
...
| `source_monitoring` | trading_daily | 33 | 2026-09-09 | **stalled** | missing trading days: 2026-08-25, 2026-08-27, 2026-08-28 |
| `source_monitoring_status` | trading_daily | 1 | 2026-09-09 | **accumulating** | — |
...
| `timeseries_shadow_forecasts` | trading_daily | 1 | 2026-09-09 | **accumulating** | — |
...
| `forecast_timestamp_proof` | weekly | 1 | 2026-09-10 | **accumulating** | — |
...
| `timeseries_v13_vol_live` | trading_daily | 1 | 2026-09-09 | **accumulating** | — |
| `timeseries_v13_vol_live_resolutions` | trading_daily | 0 | — | **planned** | — |
| `timeseries_v13_vol_ladder_results` | event | 5 | — | **accumulating** | — |
