...
- Generated: `2026-08-25T02:37:19+00:00`
- Latest completed NYSE day: `2026-08-24`
...
| `scenario_archive` | trading_daily | 23 | 2026-08-24 | **stalled** | missing trading days: 2026-08-04, 2026-08-05 |
| `scenario_latest` | trading_daily | 1 | 2026-08-24 | **accumulating** | — |
| `cross_asset_archive` | trading_daily | 21 | 2026-08-21 | **stalled** | missing trading days: 2026-08-04 |
| `cross_asset_latest` | trading_daily | 1 | 2026-08-21 | **stalled** | — |
| `cross_asset_path_tracking` | trading_daily | 1 / 3 | — | **frozen** | — |
| `cross_asset_path_tracking_v2` | trading_daily | 1 / 42 | 2026-08-21 | **stalled** | — |
| `scenario_band_calibration` | trading_daily | 1 / 91 | 2026-08-24 | **accumulating** | — |
...
| `rate_event_archive` | monthly | 16 | 2026-08-21 | **accumulating** | — |
| `realty_rate_sensitivity_archive` | monthly | 16 | 2026-08-21 | **accumulating** | — |
...
| `source_monitoring` | trading_daily | 21 | 2026-08-24 | **accumulating** | — |
| `source_monitoring_status` | trading_daily | 1 | 2026-08-24 | **accumulating** | — |
...
| `forecast_timestamp_proof` | weekly | 1 | 2026-08-25 | **accumulating** | — |
