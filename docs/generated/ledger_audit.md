...
- Generated: `2026-08-22T02:34:39+00:00`
- Latest completed NYSE day: `2026-08-21`
- Result: accumulating 29 · frozen 1 · stalled 7 · inactive 5 · violation 0 · planned 3

| Ledger | Cadence | Files / rows | Latest | Status | Finding |
|---|---:|---:|---:|---:|---|
| `forecast_records` | event | 23 | 2026-08-08 | **accumulating** | — |
| `forecast_evidence` | event | 18 | 2026-08-08 | **accumulating** | — |
| `ml_market_history` | weekly | 1 | 2026-08-15 | **accumulating** | — |
...
| `cost_ledger` | event | 1 / 11 | — | **accumulating** | — |
| `provider_shadow_ledger` | event | 1 / 0 | — | **accumulating** | — |
| `scenario_archive` | trading_daily | 22 | 2026-08-21 | **stalled** | missing trading days: 2026-08-04, 2026-08-05 |
| `scenario_latest` | trading_daily | 1 | 2026-08-21 | **accumulating** | — |
| `cross_asset_archive` | trading_daily | 20 | 2026-08-20 | **stalled** | missing trading days: 2026-08-04 |
| `cross_asset_latest` | trading_daily | 1 | 2026-08-20 | **stalled** | — |
| `cross_asset_path_tracking` | trading_daily | 1 / 3 | — | **frozen** | — |
| `cross_asset_path_tracking_v2` | trading_daily | 1 / 39 | 2026-08-20 | **stalled** | — |
| `scenario_band_calibration` | trading_daily | 1 / 78 | 2026-08-21 | **accumulating** | — |
| `market_event_calendar` | event | 1 / 53 | 2026-08-04 | **accumulating** | — |
| `signal_archive` | weekly | 6 | 2026-08-21 | **accumulating** | — |
| `liquidity_archive` | weekly | 4 | 2026-08-21 | **accumulating** | — |
| `rate_event_archive` | monthly | 15 | 2026-08-20 | **accumulating** | — |
| `realty_rate_sensitivity_archive` | monthly | 15 | 2026-08-20 | **accumulating** | — |
...
| `source_monitoring` | trading_daily | 19 | 2026-08-21 | **accumulating** | — |
| `source_monitoring_status` | trading_daily | 1 | 2026-08-21 | **accumulating** | — |
...
| `timeseries_model_runs` | weekly | 1 | — | **accumulating** | — |
| `timeseries_backtest_runs` | monthly | 1 | — | **accumulating** | — |
| `raw_receipts` | event | 0 | — | **planned** | — |
| `quarantine` | event | 0 | — | **planned** | — |
| `bitemporal_facts` | event | 0 | — | **planned** | — |
| `forecast_timestamp_proof` | weekly | 1 | 2026-08-22 | **accumulating** | — |
