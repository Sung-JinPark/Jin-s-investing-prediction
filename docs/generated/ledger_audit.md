...
- Generated: `2026-08-21T02:42:32+00:00`
- Latest completed NYSE day: `2026-08-20`
...
| `scenario_archive` | trading_daily | 21 | 2026-08-20 | **stalled** | missing trading days: 2026-08-04, 2026-08-05 |
| `scenario_latest` | trading_daily | 1 | 2026-08-20 | **accumulating** | — |
| `cross_asset_archive` | trading_daily | 19 | 2026-08-19 | **stalled** | missing trading days: 2026-08-04 |
| `cross_asset_latest` | trading_daily | 1 | 2026-08-19 | **stalled** | — |
| `cross_asset_path_tracking` | trading_daily | 1 / 3 | — | **frozen** | — |
| `cross_asset_path_tracking_v2` | trading_daily | 1 / 36 | 2026-08-19 | **stalled** | — |
| `scenario_band_calibration` | trading_daily | 1 / 66 | 2026-08-20 | **accumulating** | — |
| `market_event_calendar` | event | 1 / 53 | 2026-08-04 | **accumulating** | — |
| `signal_archive` | weekly | 5 | 2026-08-14 | **accumulating** | — |
| `liquidity_archive` | weekly | 3 | 2026-08-14 | **accumulating** | — |
| `rate_event_archive` | monthly | 14 | 2026-08-19 | **accumulating** | — |
| `realty_rate_sensitivity_archive` | monthly | 14 | 2026-08-19 | **accumulating** | — |
...
| `source_monitoring` | trading_daily | 18 | 2026-08-20 | **accumulating** | — |
| `source_monitoring_status` | trading_daily | 1 | 2026-08-20 | **accumulating** | — |
...
| `forecast_timestamp_proof` | weekly | 1 | 2026-08-21 | **accumulating** | — |
