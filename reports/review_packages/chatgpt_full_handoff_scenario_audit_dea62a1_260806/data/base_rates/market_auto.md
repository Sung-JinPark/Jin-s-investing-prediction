...
> `python -m ai_fc market` — Kalshi·Polymarket·CBOE 옵션(무료·무인증). 생성: 2026-08-03
...
| nasdaq-eoy-above-jul9-2026 | **42%** | options_bl | P(만기 종가 임계 상회/하회) — risk-neutral |
| nasdaq-ath-eoy-2026 | **33%** | options_bl (경로 질문의 종점 하한) | P(만기 종가 임계 상회/하회) — risk-neutral |
