...
from ai_fc.timeseries_v7_r4.e2_student_t import E2Contract, fit_e2_student_t
...
def test_e2_uses_contract_grid_and_joint_student_t_likelihood() -> None:
    ...
    assert model.diagnostics["objective"] == "joint_location_scale_student_t_nll"
...
def test_e2_scale_initialization_uses_only_cross_fitted_residuals() -> None:
    ...
    assert evidence["row_count"] == 36 * 4
